...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["food-food-module"], {
  ...
  function srcAppFoodFoodModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _food_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./food.page */
    ...
    FoodPageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: FoodPageModule
    });
    FoodPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function FoodPageModule_Factory(t) {
        return new (t || FoodPageModule)();
      },
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](FoodPageModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](FoodPageModule, [{
  ...
  /***/
  function srcAppFoodFoodPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function FoodPage_ion_item_8_Template(rf, ctx) {
      if (rf & 1) {
    ...
    FoodPage.ɵfac = function FoodPage_Factory(t) {
      return new (t || FoodPage)();
    };

    FoodPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: FoodPage,
      selectors: [["app-list"]],
      decls: 9,
      vars: 1,
      consts: [["color", "primary"], ["slot", "start"], [4, "ngFor", "ngForOf"], ["slot", "start", 3, "name"], ["slot", "end", 1, "item-note"]],
      template: function FoodPage_Template(rf, ctx) {
        if (rf & 1) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](FoodPage, [{
